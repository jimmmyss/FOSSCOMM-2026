...
@media (hover: hover) {
    ...
    /* No hand for simply passing over the row: that is the cursor telling you
       about a gesture you have not asked for. A speaker under the pointer gets
       the pointer, because it can be clicked, and the hand appears when a hand
       is actually holding the row. */
