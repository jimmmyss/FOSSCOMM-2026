            ...
            <?php foreach ($columns as $col) : ?>
                <?php if ($col['kind'] === 'participate') :
                    ...
                    <div class="fc-gi-col"<?php if ($has_clock) : ?>
                        ...
                        <?php endif; ?>
                        <?php if ($p_body !== '') : ?>
                            <div class="fc-gi-body"><?php echo wp_kses_post(fc_format_block($p_body)); ?></div>
                        <?php endif; ?>
                ...
                <?php else : ?>
                    <div class="fc-gi-col">
                        ...
                        <?php endif; ?>
                        <?php if ($col['body'] !== '') : ?>
                            <div class="fc-gi-body"><?php echo wp_kses_post(fc_format_block($col['body'])); ?></div>
                        <?php endif; ?>
...
/* The description: the site's body text. */
.fc-gi-body {
    margin-top: 1.25rem;
    max-width: 28rem;
    font-size: 1.125rem;
