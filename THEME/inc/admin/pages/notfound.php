...
function fc_admin_page_404() {
    fc_render_section_admin_page([
        ...
        'title'      => '404 Page',
        'option_key' => 'fc_404',
        'intro'      => 'Shown when a visitor hits a URL that doesn\'t exist. The optional heading appears above the message, in the same face as a section heading, and the way back home is added automatically as a button — the site\'s display face with its <code>&gt;</code>. You can use <code>*word*</code> to highlight a word in the accent pixel face, and <code>[text](https://…)</code> for a link.',
        'schema'     => [
            'title'   => 'bilingual',
