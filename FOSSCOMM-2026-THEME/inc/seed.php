...
function fc_seed_initial_content() {
    ...
    fc_seed_if_empty('fc_section_venue', [
        ...
        'coords_lat'          => '37.9838°N',
        'coords_lon'          => '23.7275°E',
        ...
        'editions' => [
            ...
            ['year' => 2026, 'city' => 'Athens',       'lat' => '37.9838', 'lon' => '23.7275', 'url' => '', 'current' => true],
        ],
    ]);

    fc_seed_if_empty('fc_sponsors', [
        ['name' => 'GFOSS',                    'tier' => 'platinum'],
        ['name' => 'Open Technologies',        'tier' => 'platinum'],
